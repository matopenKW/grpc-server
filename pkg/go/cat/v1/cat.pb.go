...
func (x *MyCatResponse) Reset() {
	*x = MyCatResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cat_cat_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MyCatResponse) Descriptor() ([]byte, []int) {
	return file_cat_cat_proto_rawDescGZIP(), []int{1}
}
...
var file_cat_cat_proto_rawDesc = []byte{
	0x0a, 0x0d, 0x63, 0x61, 0x74, 0x2f, 0x63, 0x61, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22,
	...
	0x00, 0x42, 0x08, 0x5a, 0x06, 0x63, 0x61, 0x74, 0x2f, 0x76, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_cat_cat_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
func file_cat_cat_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cat_cat_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
